...
from config import load_config_from_file, TripletTrainingConfig, GenerateEmbeddingsConfig
...
def main():
    ...
    if not checkpoint_path.exists():
        raise FileNotFoundError(f"Checkpoint not found at {checkpoint_path} or {train_config.checkpoint_dir}")
    ...
    import shutil
    shutil.copy(project_root / "publish_model/configuration_spatial_embeddings.py", output_dir)
    shutil.copy(project_root / "publish_model/modeling_spatial_embeddings.py", output_dir)
